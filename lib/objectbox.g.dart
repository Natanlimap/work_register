...
final _entities = <obx_int.ModelEntity>[
  obx_int.ModelEntity(
      id: const obx_int.IdUid(1, 341356959039316362),
      name: 'Activity',
      lastPropertyId: const obx_int.IdUid(3, 5548138280403181943),
      flags: 0,
      properties: <obx_int.ModelProperty>[
        obx_int.ModelProperty(
            id: const obx_int.IdUid(1, 185990740070986908),
            name: 'id',
            type: 6,
            flags: 1),
        obx_int.ModelProperty(
            id: const obx_int.IdUid(2, 8719195957932224512),
            name: 'name',
            type: 9,
            flags: 0),
        obx_int.ModelProperty(
            id: const obx_int.IdUid(3, 5548138280403181943),
            name: 'time',
            type: 10,
            flags: 0)
      ],
...
obx_int.ModelDefinition getObjectBoxModel() {
  final model = obx_int.ModelInfo(
      entities: _entities,
      lastEntityId: const obx_int.IdUid(1, 341356959039316362),
  ...
  final bindings = <Type, obx_int.EntityDefinition>{
    Activity: obx_int.EntityDefinition<Activity>(
        ...
        objectFromFB: (obx.Store store, ByteData fbData) {
          ...
          final object =
              Activity(id: idParam, name: nameParam, time: timeParam);
...
class Activity_ {
  ...
  /// See [Activity.time].
  static final time =
      obx.QueryDateProperty<Activity>(_entities[0].properties[2]);
}
